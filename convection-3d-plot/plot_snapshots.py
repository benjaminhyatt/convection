...
def main(filename, start, count, output):
    ...
    t_mar, b_mar, l_mar, r_mar = (0.125*aspect, 0.25*aspect, 0.4*aspect, 0.1*aspect)
    h_plot, w_plot = (1., aspect)
    w_pad = l_mar
    h_pad = 0.24 * aspect * h_plot
    h_cbar = 0.1 * aspect * h_plot
    h_pad2 = 0.16 * aspect * h_plot

    h_total = t_mar + h_pad + h_cbar + h_pad2 + h_plot + b_mar
    ...
    bottom2 = 1 - (t_mar + h_pad + h_cbar + h_pad2 + h_plot) / h_total
    ...
    left2c = (l_mar + w_plot + w_pad) / w_total
    bottom2c = 1 - (t_mar + h_pad + h_cbar) / h_total
    ...
    for index in range(start, start+count):
        ...
        title_height = 1 - 0.4 * aspect * t_mar
