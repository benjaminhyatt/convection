...
Usage:
    plot_ux_uz_T.py <files>... [--output=<dir>]
...
def main(filename, start, count, output):
    ...
    # Plot settings
    tasks_profiles = ['T_bar']
    tasks_snapshots = ['T-T_bar', 'u_x', 'u_z']
    
    titles_profiles = {}
    titles_profiles['T_bar'] = r'$\overline{T}$'

    titles_snapshots = {}
    titles_snapshots['T-T_bar'] = r'$T - \overline{T}$'
    titles_snapshots['u_x'] = r'$u_x$'
    titles_snapshots['u_z'] = r'$u_z$'
