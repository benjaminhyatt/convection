...
def main(filename, start, count, output):
    ...
    # Plot settings
    #tasks = ['temp', 'u_x', 'u_z', 'pressure']
    tasks = ['temp-rms', 'u_x', 'u_z', 'pressure']
    #tasks = ['temp-anom', 'u_x', 'u_z', 'pressure']

    #tasks = ['Tp', 'Tp-anom', 'u_x', 'u_z']

    titles = {}
    titles['temp'] = r'$T_1$'
    titles['temp-rms'] = r'$T_1/\|T_1\|$'
    titles['temp-anom'] = r'$T_1/\overline{T_1}$'
    titles['Tp'] = r"$T'$"
    titles['Tp-anom'] = r"$T'/\overline{T'}$"
    titles['u_x'] = r'$u_x$'
    titles['u_z'] = r'$u_z$'
    titles['pressure'] = r'$p$'
