...
# picks out the minimum cumulative flux (starting from z=0) at height z=L_CZ
...
# find height z_match where T_rad(flux, k) matches the adiabatic gradient
...
logger.info('right(integ(heating - cooling)): {:.3e}'.format(reducer.global_max(fH2(z = Lz)['g']))) # currently is around 2e-6, but should it be zero to floating point precision?
